angular.module('itunes').controller('mainCtrl', function($scope, itunesService) {
    ...
    $scope.gridOptions = {
        ...
        columnDefs: [{
            ...
            displayName: 'Play',
            width: '40px',
            cellTemplate: '<div class="ngCellText" ng-class="col.colIndex()"><a href="{{row.getProperty(col.field)}}"><img src="http://findicons.com/files/icons/2579/iphone_icons/30/music_beamed_note.png"></a></div>'
        }, {
            field: 'Artist',
            displayName: 'Artist'
        }, {
    ...
    //the input box on index.html, head over there and check if that input box is tied to any specific
    //model we could use.
...
/*
      ...
      Type: "song"
  */
//the iTunes API is going to give you a lot more details than ng-grid wants. Create a new array and then loop through the iTunes data pushing into your new array objects that look
//like the above data.
...
//Once you have that final data array, you simply need to put it on the scope (or more specifically on the scope as songData). Once you do this ($scope.songData = myFinalArray)
